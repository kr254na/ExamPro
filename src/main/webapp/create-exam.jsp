...
<head>
    ...
    <title>Create Exam | ExamPro</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .input-row { display: grid; grid-template-columns: 1fr 200px; gap: 1.5rem; margin-bottom: 2rem; }
...
<body>
    ...
    <main class="main-content">
        <header>
            <div>
                <h1>Assemble New Exam</h1>
                <p style="color:var(--muted)">Combine your bank questions into a published test.</p>
            </div>
        ...
        <div class="form-container">
            <form action="/exam/new" method="post">
                <div class="input-row" style="grid-template-columns: 1fr 1fr 150px;">
                    <div class="form-group">
                        <label>Exam Title</label>
                        <input type="text" name="examTitle" placeholder="e.g. Mid-Term Assessment" required>
                    </div>

                    <div class="form-group">
                        <label>Subject Name</label>
                        <input type="text" name="subjectName" placeholder="e.g. Python / DBMS" required>
                    </div>
                ...
                <div class="question-selector">
                    <c:forEach var="q" items="${myQuestions}">
                        <label class="q-item">
                            <input type="checkbox" name="selectedQuestions" value="${q.id}" class="q-checkbox">
                            <div class="q-info" style="flex: 1;">
                                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px;">
                                    <h4 style="margin: 0; font-size: 1rem;">${q.questionText}</h4>
                                    <span class="q-tag" style="background: rgba(59,142,243,0.1); padding: 2px 8px; border-radius: 4px; white-space: nowrap; margin-left: 10px;">
                                        ${q.subjectName}
                                    </span>
                                </div>

                                <%-- Options Preview Grid --%>
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 0.8rem; color: var(--muted); margin-bottom: 8px;">
                                ...
                                <div style="font-size: 0.75rem; font-weight: 700; color: var(--success); display: flex; align-items: center; gap: 5px;">
                ...
                <button type="submit" class="btn-create">Publish Exam to Students</button>
            </form>
        </div>
    </main>

    <script>
        // Simple script to update the counter
